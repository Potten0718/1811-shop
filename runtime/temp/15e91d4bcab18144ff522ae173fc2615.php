<?php /*a:6:{s:79:"D:\lening\PHPTutorial\WWW\shop\application\index\view\address\address_edit.html";i:1556067180;s:65:"D:\lening\PHPTutorial\WWW\shop\application\index\view\layout.html";i:1554338448;s:72:"D:\lening\PHPTutorial\WWW\shop\application\index\view\public\header.html";i:1555931526;s:74:"D:\lening\PHPTutorial\WWW\shop\application\index\view\public\user_top.html";i:1554340990;s:75:"D:\lening\PHPTutorial\WWW\shop\application\index\view\public\user_left.html";i:1554304003;s:72:"D:\lening\PHPTutorial\WWW\shop\application\index\view\public\footer.html";i:1554280142;}*/ ?>
...
<div class="soubg">
    <div class="sou">
        ...
        <span class="fr">
            <span class="fl">
              <?php if(app('session')->get('uinfo') == ''): ?>
              你好！请<a href="<?php echo url('login/login'); ?>">登陆</a>
              <a href="<?php echo url('login/register'); ?> style="...">免费注册</a>
              <a href="">&nbsp;&nbsp;</a>
              <?php else: ?>
              欢迎<?php echo htmlentities(app('session')->get('uinfo.user_email')); ?><a href="<?php echo url('login/login'); ?>">登录</a>&nbsp; 
              <a href="<?php echo url('login/loginOut'); ?>" style="color:#ff4e00;">退出</a>
              <a href="<?php echo url('user/index'); ?>" style="color:#ff4e00;">个人中心</a>
              <?php endif; ?>
            </span>
            <span class="ss">
                <div class="ss_list">
    ...
    <div class="m_right">
            ...
            <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td colspan="3" style="font-family:'宋体';">
                  <select class="area" id="province">
                      ...
                      <?php if(is_array($provinceInfo) || $provinceInfo instanceof \think\Collection || $provinceInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $provinceInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if(($v['id']==$addressInfo['province'])): ?>
                      <option value="<?php echo htmlentities($v['id']); ?>" selected><?php echo htmlentities($v['name']); ?></option>
                      <?php else: ?>
                    ...
                    <select class="area" id="city">
                      <option value="0" selected="selected">请选择...</option>
                      <?php if(is_array($cityInfo) || $cityInfo instanceof \think\Collection || $cityInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $cityInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if(($v['id']==$addressInfo['city'])): ?>
                      <option value="<?php echo htmlentities($v['id']); ?>" selected><?php echo htmlentities($v['name']); ?></option>
                      <?php else: ?>
                      <option value="<?php echo htmlentities($v['id']); ?>"><?php echo htmlentities($v['name']); ?></option>
                      <?php endif; ?>
                    ...
                    <select class="area" id="areaa">
                      <option value="0" selected="selected">请选择...</option>
                      <?php if(is_array($areaInfo) || $areaInfo instanceof \think\Collection || $areaInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $areaInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if(($v['id']==$addressInfo['area'])): ?>
                      <option value="<?php echo htmlentities($v['id']); ?>" selected><?php echo htmlentities($v['name']); ?></option>
                      <?php else: ?>
                      <option value="<?php echo htmlentities($v['id']); ?>" ><?php echo htmlentities($v['name']); ?></option>
                      <?php endif; ?>
              ...
              <tr>
                ...
                <td style="font-family:'宋体';"><input type="text" id="address_name" class="add_ipt" value="<?php echo htmlentities($addressInfo['address_name']); ?>" />（必填）</td>
                <td align="right">电话</td>
                <td style="font-family:'宋体';"><input type="text" id="address_tel" class="add_ipt" value="<?php echo htmlentities($addressInfo['address_tel']); ?>" />（必填）</td>
              </tr>
              <tr>
                <td align="right">详细地址</td>
                <td style="font-family:'宋体';"><input type="text" id="address_detail" class="add_ipt" value="<?php echo htmlentities($addressInfo['address_detail']); ?>" />（必填）</td>
                <td align="right">邮政编码</td>
                <td style="font-family:'宋体';"><input type="text" id="address_mail" class="add_ipt" value="<?php echo htmlentities($addressInfo['address_mail']); ?>" /></td>
              </tr>
                <tr>
                  <td colspan="4">
                    <input type="checkbox" id="is_default" <?php if(($addressInfo['is_default']==1)): ?> checked<?php endif; ?>>是否设置为默认收货地址
                  </td>
                </tr>
            </table>
            <p align="right">
            ...
            <input type="hidden" id="address_id" value="<?php echo htmlentities($addressInfo['address_id']); ?>">
...
<script type="text/javascript">
  $(function(){
    ...
    $('.add_b').click(function(){
      ...
      $.post(
          "<?php echo url('address/addressEditDo'); ?>",
          data,
          function(res){
    ...
    $('.edit').click(function(){
      ...
      location.href="<?php echo url('Address/addressEdit'); ?>?address_id="+address_id;
    });
