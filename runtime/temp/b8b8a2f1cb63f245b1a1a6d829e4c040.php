        ...
        <div class="banner">        
            <div class="top_slide_wrap">
                <ul class="slide_box bxslider">
                    ...
                    <li><img src="/static/index/images/baobei1.jpg" width="740" height="401" /></li> 
                    <li><img src="/static/index/images/baobei2.jpg" width="740" height="401" /></li> 
                </ul>   
    ...
    <!--Begin 进口 生鲜 Begin-->   
        <div class="i_t mar_10">
            ...
            <span class="i_mores fr">
                ...
                <a href="#"></a><?php echo htmlentities($v['cate_name']); ?>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </span>  
        </div> 
        <div class="content">
            ...
            <div class="fresh_mid">
                <ul>
                    ...
                    <li>
                        <div class="name"><a><?php echo htmlentities($v['goods_name']); ?></a></div>
                        <div class="price">
                        ...
                        <div class="img">
                          <a href="<?php echo url('Goods/goodsDetail'); ?>?goods_id=<?php echo htmlentities($v['goods_id']); ?>">
                            <img src="<?php echo htmlentities($v['goods_img']); ?>" width="185" height="155" />
                         </a>
                        </div>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
