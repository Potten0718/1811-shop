<?php /*a:5:{s:73:"D:\lening\PHPTutorial\WWW\shop\application\index\view\cart\cart_list.html";i:1556351397;s:65:"D:\lening\PHPTutorial\WWW\shop\application\index\view\layout.html";i:1556351553;s:72:"D:\lening\PHPTutorial\WWW\shop\application\index\view\public\header.html";i:1556351482;s:69:"D:\lening\PHPTutorial\WWW\shop\application\index\view\public\nav.html";i:1556351493;s:72:"D:\lening\PHPTutorial\WWW\shop\application\index\view\public\footer.html";i:1556351483;}*/ ?>
...
<div class="menu_bg">
    <div class="menu">
        ...
        <div class="nav">
            ...
            <div class="<?php echo htmlentities($is_show); ?>">
                <ul>      
                    ...
                    <?php if(is_array($cateInfo) || $cateInfo instanceof \think\Collection || $cateInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $cateInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="/static/index/images/nav2.png" /></span>
                            <span class="fl"><?php echo htmlentities($vo['cate_name']); ?></span>
                        </div>
                        <div class="zj" style="top:-<?php echo htmlentities($key*40); ?>px;">
                            <div class="zj_l">
                                 <?php if(is_array($vo['son']) || $vo['son'] instanceof \think\Collection || $vo['son'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['son'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?>
                                <div class="zj_l_c">   
        ...
        <!--End 商品分类详情 End-->                                                     
        <ul class="menu_r">
            <li><a href="<?php echo url('index/goods/goodsList'); ?>">全部商品</a></li>
            <?php if(is_array($cate_model) || $cate_model instanceof \think\Collection || $cate_model instanceof \think\Paginator): $i = 0; $__LIST__ = $cate_model;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
...
<div class="i_bg">  
    ...
    <div class="content mar_20">
        <table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          <tr>
          <td><input type="checkbox" class="all" id="allbox"></td>
          ...
          <tr goods_num="<?php echo htmlentities($v['goods_num']); ?>" goods_id="<?php echo htmlentities($v['goods_id']); ?>">
            ...
            <td align="center">
            <?php if($v['add_price'] > $v['goods_price']): ?>
                <font color="red">比加入时减少了<?php echo htmlentities($v['add_price']-$v['goods_price']); ?>元</font><br>
                <?php echo htmlentities($v['goods_price']); else: ?>
                <?php echo htmlentities($v['goods_price']); ?>
            <?php endif; ?>
            </td>
            <td align="center">
                <div class="c_num">
            ...
            <td align="center" style="color:#ff4e00;" >￥<?php echo htmlentities($v['goods_price']*$v['buy_number']); ?></td>
          ...
          <tr height="70">
            <td colspan="6" style="font-family:'Microsoft YaHei'; border-bottom:0;">
                <label class="r_rad"><input type="checkbox" name="clear" checked="checked" /></label><label class="r_txt"  id="delMany">批量删除购物车</label>
          ...
          <tr valign="top" height="150">
            <td colspan="6" align="right">
                <a href="#"><img src="/static/index/images/buy1.gif" /></a>&nbsp; &nbsp;
                 <a href="javascript:;" id="conform"><img src="/static/index/images/buy2.gif" /></a>
            </td>
          </tr>
        </table>
        ...
        $('.car_btn_2').click(function(){
            ...
            $.ajax({
                ...
                success:function(res){
                    // console.log(111);
                    // if(res.code==2){
                    //     layer.msg(res.content,{icon:res.icon});
                    //     flag=1;
                    }
            })
            if(flag==1){
