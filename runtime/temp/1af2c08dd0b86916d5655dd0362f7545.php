<?php /*a:1:{s:70:"D:\lening\PHPTutorial\WWW\shop\application\index\view\login\login.html";i:1556351451;}*/ ?>
<!DOCTYPE html>
<html>
							...
							<div class="login-form">
								<form>
									<div class="user-name">
										...
										<input type="text" id="account" value="<?php echo isset($info['account']) ? htmlentities($info['account']) : ''; ?>" placeholder="手机号/邮箱">
									</div>
									<div class="user-pass">
										<label for="user_pwd"><i class="am-icon-lock"></i></label>
										<input type="password" id="user_pwd" value="<?php echo isset($info['user_pwd']) ? htmlentities($info['user_pwd']) : ''; ?>" placeholder="请输入密码">
									</div>
								</form>
							</div>
	    ...
	    layui.use(['layer'],function(){
			...
			$('#btn').click(function(){
				...
				$.post(
					...
					function(msg){
				        layer.msg(msg.content,{icon:msg.icon},function(){
				        	  if(msg.code==1){
