<?php /*a:2:{s:68:"D:\lening\PHPTutorial\WWW\shop\application\admin\view\role\edit.html";i:1555904574;s:65:"D:\lening\PHPTutorial\WWW\shop\application\admin\view\layout.html";i:1555895948;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="hidden" name="role_id" value="<?php echo htmlentities($data['role_id']); ?>" id="role_id">
      <input type="text" name="role_name"  value="<?php echo htmlentities($data['role_name']); ?>" required  lay-verify="required|checkOnly" placeholder="" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item layui-form-text">
    <label class="layui-form-label">描述</label>
    <div class="layui-input-block">
      <textarea name="role_content"  placeholder="" class="layui-textarea"><?php echo htmlentities($data['role_content']); ?></textarea>
    </div>
  </div>
  <div class="layui-form-item">
    <div class="layui-input-block">
