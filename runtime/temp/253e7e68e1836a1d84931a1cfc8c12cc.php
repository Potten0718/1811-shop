<?php /*a:2:{s:72:"D:\lening\PHPTutorial\WWW\shop\application\admin\view\gonggao\index.html";i:1554031508;s:65:"D:\lening\PHPTutorial\WWW\shop\application\admin\view\layout.html";i:1555895948;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
  ...
  <tbody>
    ...
    <tr gong_id="<?php echo htmlentities($vo['gong_id']); ?>" >
      <td><?php echo htmlentities($i); ?></td>
      <td><?php echo htmlentities($vo['gong_title']); ?></td>
      <td><?php echo htmlentities($vo['release_status']); ?></td>
      <td><?php echo htmlentities($vo['release_time']); ?></td>
      <td>
        [<a>删除</a>]
      </td>
    </tr>
...
<script type="text/javascript">
  layui.use(['layer','jquery'],function(){
    ...
    $('td:nth-child(3)').click(function(){
      $.post(
          "<?php echo url('gonggao/editStatus'); ?>",
