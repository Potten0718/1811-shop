<?php /*a:2:{s:73:"D:\lening\PHPTutorial\WWW\shop\application\admin\view\gonggao\create.html";i:1554028072;s:65:"D:\lening\PHPTutorial\WWW\shop\application\admin\view\layout.html";i:1554108201;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    layui.use(['form','jquery','layer'], function(){
      ...
      form.verify({
        checkOnly:function(value){
          var text;
          $.ajax({
            url:"<?php echo url('gonggao/checkOnly'); ?>",
            method:"post",
            async:false,
      ...
      form.on('submit(formDemo)', function(data){
        $.post(
          "<?php echo url('gonggao/save'); ?>",
          data.field,
          function(msg){
            layer.msg(msg.content,{icon:msg.icon,time:1000},function(){
              if(msg.code==1){
                location.href="<?php echo url('gonggao/index'); ?>";
              };
            });
          },
          'json'
