<?php /*a:2:{s:76:"D:\lening\PHPTutorial\WWW\shop\application\admin\view\admin\update_pass.html";i:1553082839;s:65:"D:\lening\PHPTutorial\WWW\shop\application\admin\view\layout.html";i:1554108201;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
  ...
  <input type="hidden" name="admin_id" value="<?php echo htmlentities(app('session')->get('info.admin_id')); ?>">
  <input type="hidden" name="admin_status" value="开启">
  <div class="layui-form-item" >
    <label class="layui-form-label">用户名</label>
    <div class="layui-input-block">
      <input type="text" name="admin_name" value="<?php echo htmlentities(app('session')->get('info.admin_name')); ?>" readonly  lay-verify="required|checkName" placeholder="请输入用户名" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
