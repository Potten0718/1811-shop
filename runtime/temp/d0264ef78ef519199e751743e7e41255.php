...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
            <div id="tsImgS"><a href="<?php echo htmlentities($goodsInfo['goods_img']); ?>" title="Images" class="MagicZoom" id="MagicZoom"><img src="<?php echo htmlentities($goodsInfo['goods_img']); ?>" width="390" height="390" /></a></div>
        ...
        <div class="pro_des">
            ...
            <div class="des_price">
                ...
                消费积分：<span><?php echo htmlentities($goodsInfo['goods_score']); ?></span>
            </div>
            ...
            <div class="des_join">
            	<div class="j_nums">
                    <input type="hidden" id="goods_num" value="<?php echo htmlentities($goodsInfo['goods_num']); ?>">
        ...
        <div class="l_list">        	
            ...
            <div class="des_border">
                ...
                <div class="des_con" id="p_attribute">
                	...
                	<?php echo htmlentities($goodsInfo['goods_desc']); ?>                                        
            ...
            <div class="des_border" id="p_details">
                ...
                <div class="des_con">
                	<table border="0" align="center" style="width:745px; font-size:14px; font-family:'宋体';" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="265"><img src="<?php echo htmlentities($goodsInfo['goods_img']); ?>" width="206" height="412" /></td>
                        <td>
                        	<b>迪奥真我香水(Q版)</b><br />
                            【商品规格】：5ml<br />
                            【商品质地】：液体<br />
